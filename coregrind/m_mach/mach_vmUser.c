/*
 * IDENTIFICATION:
 * stub generated Tue Oct 10 20:30:57 2017
...
#if ( __MigTypeCheck )
#if __MIG_check__Reply__mach_vm_subsystem__
#if !defined(__MIG_check__Reply___kernelrpc_mach_vm_purgable_control_t__defined)
#define __MIG_check__Reply___kernelrpc_mach_vm_purgable_control_t__defined

mig_internal kern_return_t __MIG_check__Reply___kernelrpc_mach_vm_purgable_control_t(__Reply___kernelrpc_mach_vm_purgable_control_t *Out0P)
{

	typedef __Reply___kernelrpc_mach_vm_purgable_control_t __Reply __attribute__((unused));
#if	__MigTypeCheck
	unsigned int msgh_size;
#endif	/* __MigTypeCheck */
...
#endif /* !defined(__MIG_check__Reply___kernelrpc_mach_vm_purgable_control_t__defined) */
#endif /* __MIG_check__Reply__mach_vm_subsystem__ */
#endif /* ( __MigTypeCheck ) */


/* Routine _kernelrpc_mach_vm_purgable_control */
mig_external kern_return_t _kernelrpc_mach_vm_purgable_control
(
	vm_map_t target_task,
	mach_vm_address_t address,
...
#ifdef	__MIG_check__Reply___kernelrpc_mach_vm_purgable_control_t__defined
	kern_return_t check_result;
#endif	/* __MIG_check__Reply___kernelrpc_mach_vm_purgable_control_t__defined */

	__DeclareSendRpc(4818, "_kernelrpc_mach_vm_purgable_control")
...
/* END VOUCHER CODE */
	...
	__BeforeSendRpc(4818, "_kernelrpc_mach_vm_purgable_control")
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_MSG_OPTION_NONE, (mach_msg_size_t)sizeof(Request), (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
	__AfterSendRpc(4818, "_kernelrpc_mach_vm_purgable_control")
	if (msg_result != MACH_MSG_SUCCESS) {
		__MachMsgErrorWithoutTimeout(msg_result);
		{ return msg_result; }
	}
...
#if	defined(__MIG_check__Reply___kernelrpc_mach_vm_purgable_control_t__defined)
	check_result = __MIG_check__Reply___kernelrpc_mach_vm_purgable_control_t((__Reply___kernelrpc_mach_vm_purgable_control_t *)Out0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ return check_result; }
#endif	/* defined(__MIG_check__Reply___kernelrpc_mach_vm_purgable_control_t__defined) */
...
#if ( __MigTypeCheck )
#if __MIG_check__Reply__mach_vm_subsystem__
#if !defined(__MIG_check__Reply__mach_vm_page_range_query_t__defined)
#define __MIG_check__Reply__mach_vm_page_range_query_t__defined

mig_internal kern_return_t __MIG_check__Reply__mach_vm_page_range_query_t(__Reply__mach_vm_page_range_query_t *Out0P)
{

	typedef __Reply__mach_vm_page_range_query_t __Reply __attribute__((unused));
#if	__MigTypeCheck
	unsigned int msgh_size;
#endif	/* __MigTypeCheck */
	if (Out0P->Head.msgh_id != 4920) {
	    if (Out0P->Head.msgh_id == MACH_NOTIFY_SEND_ONCE)
		{ return MIG_SERVER_DIED; }
	    else
		{ return MIG_REPLY_MISMATCH; }
...
#endif /* !defined(__MIG_check__Reply__mach_vm_page_range_query_t__defined) */
#endif /* __MIG_check__Reply__mach_vm_subsystem__ */
#endif /* ( __MigTypeCheck ) */


/* Routine mach_vm_page_range_query */
mig_external kern_return_t mach_vm_page_range_query
(
	vm_map_t target_map,
...
#pragma pack()
...
#ifdef	__MIG_check__Reply__mach_vm_page_range_query_t__defined
	kern_return_t check_result;
#endif	/* __MIG_check__Reply__mach_vm_page_range_query_t__defined */

	__DeclareSendRpc(4820, "mach_vm_page_range_query")
	...
	InP->dispositions = dispositions;

	InP->dispositions_count = *dispositions_count;
...
/* END VOUCHER CODE */
	...
	__BeforeSendRpc(4820, "mach_vm_page_range_query")
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_MSG_OPTION_NONE, (mach_msg_size_t)sizeof(Request), (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
	__AfterSendRpc(4820, "mach_vm_page_range_query")
	if (msg_result != MACH_MSG_SUCCESS) {
		__MachMsgErrorWithoutTimeout(msg_result);
		{ return msg_result; }
	}
...
#if	defined(__MIG_check__Reply__mach_vm_page_range_query_t__defined)
	check_result = __MIG_check__Reply__mach_vm_page_range_query_t((__Reply__mach_vm_page_range_query_t *)Out0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ return check_result; }
#endif	/* defined(__MIG_check__Reply__mach_vm_page_range_query_t__defined) */

	*dispositions_count = Out0P->dispositions_count;
