...
#pragma pack(4)
	...
	typedef struct {
		...
		int state;
	} __Request___kernelrpc_vm_purgable_control_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack()
#endif
...
#pragma pack(4)
	...
	typedef struct {
		...
		kern_return_t RetCode;
		int state;
	} __Reply___kernelrpc_vm_purgable_control_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack()
#endif
...
union __ReplyUnion__vm_map_subsystem {
	...
	__Reply___kernelrpc_vm_purgable_control_t Reply__kernelrpc_vm_purgable_control;
};
...
mig_internal novalue _X_kernelrpc_vm_purgable_control
	(mach_msg_header_t *InHeadP, mach_msg_header_t *OutHeadP);
...
#if ( __MigTypeCheck )
#if __MIG_check__Request__vm_map_subsystem__
#if !defined(__MIG_check__Request___kernelrpc_vm_purgable_control_t__defined)
#define __MIG_check__Request___kernelrpc_vm_purgable_control_t__defined

mig_internal kern_return_t __MIG_check__Request___kernelrpc_vm_purgable_control_t(__attribute__((__unused__)) __Request___kernelrpc_vm_purgable_control_t *In0P)
{

	typedef __Request___kernelrpc_vm_purgable_control_t __Request;
#if	__MigTypeCheck
	if ((In0P->Head.msgh_bits & MACH_MSGH_BITS_COMPLEX) ||
	    (In0P->Head.msgh_size != (mach_msg_size_t)sizeof(__Request)))
		return MIG_BAD_ARGUMENTS;
...
#endif /* !defined(__MIG_check__Request___kernelrpc_vm_purgable_control_t__defined) */
#endif /* __MIG_check__Request__vm_map_subsystem__ */
#endif /* ( __MigTypeCheck ) */


/* Routine _kernelrpc_vm_purgable_control */
#ifdef	mig_external
mig_external
#else
extern
#endif	/* mig_external */
kern_return_t _kernelrpc_vm_purgable_control
(
	vm_map_t target_task,
	vm_address_t address,
	vm_purgable_t control,
...
#pragma pack()
#endif
	typedef __Request___kernelrpc_vm_purgable_control_t __Request;
	typedef __Reply___kernelrpc_vm_purgable_control_t Reply __attribute__((unused));
	...
	Request *In0P = (Request *) InHeadP;
	Reply *OutP = (Reply *) OutHeadP;
#ifdef	__MIG_check__Request___kernelrpc_vm_purgable_control_t__defined
	kern_return_t check_result;
#endif	/* __MIG_check__Request___kernelrpc_vm_purgable_control_t__defined */

	__DeclareRcvRpc(3830, "_kernelrpc_vm_purgable_control")
	__BeforeRcvRpc(3830, "_kernelrpc_vm_purgable_control")

#if	defined(__MIG_check__Request___kernelrpc_vm_purgable_control_t__defined)
	check_result = __MIG_check__Request___kernelrpc_vm_purgable_control_t((__Request *)In0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ MIG_RETURN_ERROR(OutP, check_result); }
#endif	/* defined(__MIG_check__Request___kernelrpc_vm_purgable_control_t__defined) */

	OutP->RetCode = _kernelrpc_vm_purgable_control(In0P->Head.msgh_request_port, In0P->address, In0P->control, &In0P->state);
	if (OutP->RetCode != KERN_SUCCESS) {
		MIG_RETURN_ERROR(OutP, OutP->RetCode);
	}
	...
	OutP->Head.msgh_size = (mach_msg_size_t)(sizeof(Reply));
	__AfterRcvRpc(3830, "_kernelrpc_vm_purgable_control")
}
...
const struct vm_map_subsystem {
	...
	(vm_address_t)0,
	{
		...
		{0, 0, 0, 0, 0, 0},
          { (mig_impl_routine_t) 0,
          (mig_stub_routine_t) _X_kernelrpc_vm_purgable_control, 4, 0, (routine_arg_descriptor_t)0, (mach_msg_size_t)sizeof(__Reply___kernelrpc_vm_purgable_control_t)},
	}
};
